...
# curr_GMF_bal = 0
# curr_GMD_bal = 0.0
# gm_token_balance = [GMM_comm,GMF_comm,GME_comm,GMD_comm]

# def update_gm_token(up_token_balance):
# 	gm_token_balance[0]=up_token_balance[0]
# 	gm_token_balance[1]=up_token_balance[1]
# 	gm_token_balance[2]=up_token_balance[2]
# 	gm_token_balance[3]=up_token_balance[3]
...
while(1):
	...
	if(curr_GMM_bal!=new_GMM_bal):
		...
		print(GMM_comm,GMF_comm,GME_comm,GMD_comm)
